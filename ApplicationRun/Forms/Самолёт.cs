...
{
    public partial class Самолёт : Form
    {
        DataSet ds;
        ...
        string sql = "SELECT * FROM Самолёт";
        ...
        private void Самолёт_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                using SqlConnection connection = new SqlConnection(connectionString);
        ...
        private void toolStripTextBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string sql_search = $"SELECT * FROM Самолёт WHERE [{toolStripComboBox1.Text}] LIKE '" + toolStripTextBox1.Text + "%'";
