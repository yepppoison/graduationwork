...
{
    public partial class СамолётПредставление : Form
    {
        DataSet ds;
        ...
        string sql = "SELECT * FROM СамолётПредставление";

        public СамолётПредставление()
        {
            InitializeComponent();
        ...
        private void Самолёты_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                using SqlConnection connection = new SqlConnection(connectionString);
        ...
        private void toolStripTextBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string sql_search = $"SELECT * FROM СамолётПредставление WHERE [{toolStripComboBox1.Text}] LIKE '" + toolStripTextBox1.Text + "%'";
